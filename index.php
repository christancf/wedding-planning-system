            ...
            <div class="popular-services-nim">
              <div class="container-nim">
                ...
                <div class="popular-services-content-nim">
                  <div class="popular-services-col-nim">
                    <i class="fas fa-envelope"></i>
                    <h4>Venue</h4>
            ...
            <div class="testimonials-nim">
              <div class="container-nim">
                ...
                <div class="testimonials-content-nim">
                  <?php
                      require 'config.php';
                      $feedback = "select feedback.feedback_content, users.first_name, users.last_name from feedback inner join users on feedback.user_id = users.user_id LIMIT 3";
                    ...
                    if($f_result !== false && $f_result->num_rows > 0){
                      while($row = $f_result->fetch_assoc()){
                            echo '<div class="testimonials-col-nim">';
                              echo '<img src="images/testimonial.png" alt="user profile picture">';
                  ...
                  <a href="review.php?user_id=<?php echo $userID;?>"><button name="btnReview">Leave a comment</button></a>
              </div>
            </div>
          </section>
