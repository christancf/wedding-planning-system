...
<html>
    ...
    <body>
        ...
        <div class="content">       
            <div class="cart-chr">
                <!--<div class="cart-promo-chr">                    
                    <form action="php/promo.php">
                        <label for="promo">Have a promo code?</label></br>
                        <input type="text" id="promo-chr" name="promo" placeholder="Ax12345">
                ...
                <div class="subtotal-chr">
                    ...
                    ?>
                            <script>window.location.replace('payment-nim.php')</script>
                    <?php
                        }
