<?php
    ...
    $sql = "SELECT * 
     ...
     echo '<p><a href = "log-out-say.php">Logout</a></p>';
    ...
    {   
        if($result->num_rows > 0)
        {
            while($row=$result->fetch_assoc())
            {
                ...
                echo "<h3><a href='user-account-say.php'>User Account Page</a></h3>";
                echo "<h3><a href='photography-say.php'>Photography Page</a></h3>";
